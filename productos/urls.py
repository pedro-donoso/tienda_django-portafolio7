...
urlpatterns = [
    ...
    path('clientes/<int:pk>/editar/',
         ClienteUpdateView.as_view(), name='cliente_update'),
    ...
    path('productos/<int:pk>/editar/',
         ProductoUpdateView.as_view(), name='producto_update'),
    ...
    path('pedidos/<int:pk>/editar/',
         PedidoUpdateView.as_view(), name='pedido_update'),
    path('pedidos/<int:pk>/eliminar/',
         PedidoDeleteView.as_view(), name='pedido_delete'),
]
